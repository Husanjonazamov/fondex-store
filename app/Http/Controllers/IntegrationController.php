    ...
    public function syncProduct(Request $request)
    {
        try {
            ...
            $fields = [
                ...
                ['name' => 'brand',                'contents' => $request->brandID ?? ''],
                ...
                ['name' => 'calories',             'contents' => (string)((int)($request->calories ?? 0))],
                ['name' => 'grams',                'contents' => (string)((int)($request->grams ?? 0))],
                ['name' => 'proteins',             'contents' => (string)((int)($request->proteins ?? 0))],
                ['name' => 'fats',                 'contents' => (string)((int)($request->fats ?? 0))],
                ['name' => 'nonveg',               'contents' => $request->nonveg ?? 'false'],
                ['name' => 'veg',                  'contents' => $request->veg ?? 'true'],
                ['name' => 'takeaway_option',      'contents' => $request->takeawayOption ?? 'false'],
                ['name' => 'add_ons_title',        'contents' => $request->addOnsTitle ?? '[]'],
                ['name' => 'add_ons_price',        'contents' => $request->addOnsPrice ?? '[]'],
                ['name' => 'product_specification','contents' => $request->product_specification ?? '{}'],
            ];

...
Route::middleware(['check.subscription'])->group(function () {
    ...
    Route::get('/items/fetch/{id}', [App\Http\Controllers\IntegrationController::class, 'getProduct'])->name('items.fetch.one');
    Route::match(['post','delete'], '/items/delete', [App\Http\Controllers\IntegrationController::class, 'deleteProduct'])->name('items.delete');
